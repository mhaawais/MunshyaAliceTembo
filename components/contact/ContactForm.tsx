...
export default function ContactForm() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8">
      <h2 className="text-3xl font-bold text-[#3d756c] mb-6">Send a Message</h2>
      ...
      <form id="contact-form" onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          ...
          className="w-full bg-[#3d756c] hover:brightness-110 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none cursor-pointer"
        >
          {isSubmitting ? (
